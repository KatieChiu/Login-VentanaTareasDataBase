...
private void limpiar(){
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Edit Form", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 204, 255))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ps=  cx.conectar().prepareStatement("SELECT * FROM u WHERE USUARIO= ?" );
            ps.setString(1, jTextField1.getText());
            //USAR RES PARA MOSTRAR LOS RESULTADOS
            res=ps.executeQuery();
            if(res.next()){
                jTextField2.setText(res.getString("USUARIO"));
                jTextField3.setText(res.getString("EMAIL"));
                jTextField4.setText(res.getString("CONTRA"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            ps=  cx.conectar().prepareStatement("DELETE FROM u  WHERE USUARIO=? " );
            ...
            if(rs>0){
                ...
                JOptionPane.showMessageDialog(null, "No ha sido eliminado");
            }
            cx.desconectar();
        } catch (SQLException ex) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            ps= cx.conectar().prepareStatement("UPDATE u SET  EMAIL=?, CONTRA=? WHERE USUARIO=? " );
            ps.setString(1, jTextField3.getText());
            ps.setString(2, jTextField4.getText());
            ps.setString(3, jTextField2.getText());
            int rs =ps.executeUpdate();
            if(rs>0){
                JOptionPane.showMessageDialog(null, "Datos modificados guardado");
            }
            else{
